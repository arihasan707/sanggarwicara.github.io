		...
		<div class="container">
			<div class="banner_content row">
				<div class="offset-lg-2 col-lg-8">
					<img class="img-fluid mb-3" src="<?php echo base_url()?>/template/front/img/banner/text.png" alt="">
					<p>Bersatu melawan covid-19, berbagi untuk selamatkan nyawa sesama. Berapapun donasi anda, sangat bermanfaat bagi mereka.</p>
