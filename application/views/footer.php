<div class="row">
	<div class="col-lg-12">
		<p class="copyright">
			...
			</script> All rights reserved | Donasi Uang <i class="fa fa-heart-o" aria-hidden="true"></i> by <a target="_blank">Ari Hasan Basri</a>
			<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
		</p>
	</div>
</div>
...
<script type="text/javascript" src="<?php echo base_url() ?>/template/front/cdnjs.cloudflare.com/ajax/libs/toastr.js/2.1.4/toastr.min.js"></script>
