                          ...
                          <tbody>
                            ...
                            foreach ($donasi->result() as $key) { ?>
                              <tr>
                                ...
                                <td><a href="" class="btn btn-sm btn-info" data-toggle="modal" data-target="#valid<?php echo $key->idDonasi ?>" data-backdrop="static" data-keyboard="false">Ubah</a></td>
                                <!-- Modal -->
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <form action="<?php echo base_url('cpaneladministrator/prosesvalidasi2') ?>" method="post">
                                          ...
                                          <div class="checkbox">
                                            <label>
                                              <input type="checkbox" name="anonim" value="anonim" <?php if ($key->namaPublish == "Nama Disamarkan") {
                                                                                                    echo "checked";
                                                                                                  } ?>> Samarkan Nama
                                            </label>
                                          </div>
