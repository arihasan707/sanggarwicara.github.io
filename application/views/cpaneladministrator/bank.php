                          ...
                          <tbody>
                            ...
                            foreach ($data->result() as $key) : ?>
                              <tr>
                                ...
                                <td class="text-center"><a href="<?php echo base_url('cpaneladministrator/bank/hapus?bank=' . $key->idBank); ?>" onclick="return confirm('Yakin Hapus?')" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a><a href="" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#bank<?php echo $key->idBank; ?>" data-backdrop="static" data-keyboard="false">Edit</a></td>
                                  ...
                                  <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalCenterTitle">Ubah Bank</h5>
