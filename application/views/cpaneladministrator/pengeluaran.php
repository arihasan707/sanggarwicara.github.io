        ...
        <div class="right_col" role="main">
          <div class="row" style="display: block;">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Penyaluran Donasi</h2><a href="#" data-toggle="modal" data-target="#tambah" data-backdrop="static" data-keyboard="false" class="btn btn-primary float-right"><i class="fa fa-plus"></i> Tambah</a>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Penyaluran Donasi</h5>
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="card-box table-responsive">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            <?php $no = 1;
                            foreach ($penyaluran->result() as $key) { ?>
                              <tr>
                                <td><?php echo $no++; ?></td>
                                ...
                                <td class="text-center"><a href="" class="btn btn-sm btn-info" data-toggle="modal" data-target="#valid<?php echo $key->idpengeluaran  ?>" data-backdrop="static" data-keyboard="false">Ubah</a> <a href="<?php echo base_url('cpaneladministrator/hapuspengeluaran?edit=' . $key->idpengeluaran) ?>" onclick="return confirm('Yakin ingin hapus?')" class="btn btn-sm btn-danger"><span class="fa fa-trash"></span></a></td>
                                <!-- Modal -->
                                <div class="modal fade" id="valid<?php echo $key->idpengeluaran; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                  <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalCenterTitle">Ubah Penyaluran Donasi</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                          <span aria-hidden="true">&times;</span>
                                        </button>
                                      </div>
