                            ...
                            <ul class="menu">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="<?php echo base_url('detailLayanan/sekolah_khusus') ?>">Sekolah Khusus</a></li>
                                        <li><a href="<?php echo base_url('detailLayanan/paud') ?>">Paud & TK</a></li>
                                ...
                                <li>
                                    <a href="<?php echo base_url('home/fasilitas') ?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Fasilitas</a>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo base_url('home/galeri_foto') ?>">Foto</a></li>
                                        <li><a href="<?php echo base_url('home/galeri_video') ?>">Video</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
